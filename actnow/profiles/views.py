...
from actnow.profiles.permissions import (
    ActNowCreatePermission,
    AllowOnlyApplicationToRegisterNewUser,
)
...
class UserProfileView(ListCreateAPIView):
    ...
    permission_classes = [ActNowCreatePermission, AllowOnlyApplicationToRegisterNewUser]
